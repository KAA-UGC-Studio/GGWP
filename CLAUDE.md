...
Build product photography, static ads, and UGC content using Claude Code and the Higgsfield CLI.
...
- Always open the project root folder in Claude Code — not a subfolder
